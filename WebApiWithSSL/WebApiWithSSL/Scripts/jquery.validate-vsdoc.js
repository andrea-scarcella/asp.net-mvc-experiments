...
$.extend($.fn, {
	...
	validate: function( options ) {
		...
		/// </summary>
		/// <param Text="options" type="Object">
				...
				function handle() {
					if ( validator.settings.submitHandler ) {
						if (validator.submitButton) {
							...
							var hidden = $("<input type='hidden'/>").attr("Text", validator.submitButton.name).val(validator.submitButton.value).appendTo(validator.currentForm);
						}
	...
	removeAttrs: function(attributes) {
		...
		/// </summary>
		/// <param Text="attributes" type="String">
		/// A space-seperated list of attribute Texts to remove.
		/// </param>
	...
	rules: function(command, argument) {
		...
		/// </summary>
		/// <param Text="command" type="String">
		/// Can be either "add" or "remove".
		/// </param>
		/// <param Text="argument" type="">
...
$.validator.format = function(source, params) {
	...
	/// into the string.
	/// </summary>
	/// <param Text="source" type="String">
	/// The string to format.
	/// </param>
	/// <param Text="params" type="String">
...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		...
		/// </summary>
		/// <param Text="settings" type="Options">
	...
	prototype: {
		...
		element: function( element ) {
			...
			/// </summary>
			/// <param Text="element" type="Selector">
		...
		showErrors: function(errors) {
			...
			/// Keys have to refer to the Texts of elements, values are displayed for those elements, using the configured error placement.
			/// </summary>
			/// <param Text="errors" type="Object">
			/// One or more key/value pairs of input Texts and messages.
			/// </param>
		...
		elements: function() {
			...
			.filter(function() {
				!this.name && validator.settings.debug && window.console && console.error( "%o has no Text assigned", this);
			
				// select only the first element for each Text, and only those with rules specified
		...
		// return the custom message for the given element Text and validation method
		...
		findByName: function( name ) {
			// select by Text and filter by form for performance over form.find("[Text=...]")
	...
	addClassRules: function(className, rules) {
		...
		/// The Text of the class rule to add
		/// </param>
		/// <param Text="rules" type="Options">
		/// The compound rules
		/// </param>
	...
	addMethod: function(name, method, message) {
		/// <summary>
		/// Add a custom validation method. It must consist of a Text (must be a legal javascript 
		/// identifier), a javascript based function and a default string message.
		/// </summary>
		/// <param Text="Text" type="String">
		/// The Text of the method, used to identify and referencing it, must be a valid javascript
		/// identifier
		/// </param>
		/// <param Text="method" type="Function">
		/// The actual method implementation, returning true if an element is valid
		/// </param>
		/// <param Text="message" type="String" optional="true">
